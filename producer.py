...
conf = {
#    'bootstrap.servers': 'localhost:9090',  # Replace with your Kafka broker(s)
   'bootstrap.servers': 'kafka0:9090,kafka1:9092,kafka2:9094',  # Replace with your Kafka broker(s)
}
